        ...
        <>
            ...
            <div className='alldetails hide_signup_div'>
                ...
                <div className='signupdetails'>
                    ...
                    <div className='logmaindiv'>
                        ...
                        <NavLink to='/login' className='logintextdiv'>Log In</NavLink>
            ...
            <div className='alldetails hide_revenue_div' id='scrollresult'>
                ...
                <div className='signupdetails'>
                    ...
                    <Button variant='contained' className='createaccountdiv text-trans'><NavLink to="/homeDashboard">Get Started Now!</NavLink></Button>
                </div>
            </div>
        </>
    )
